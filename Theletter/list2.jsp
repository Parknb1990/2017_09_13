...
<%
	...
	try {
		...
		String sqlList = "SELECT NUM, USERNAME, TITLE, HIT, INDENT from board2 order by REF DESC, STEP ASC";
...
<td>&nbsp;</td>
	...
	<td align="left">
		...
		<%
			...
			if(indent!=0){
		%>		<img src='images/re2.png' height="20" width="20"/>
		<%
			}
		%> 
	<a href="view2.jsp?idx=<%=idx%>"
