...
<table>
<form name=replyform method=post action="reply_ok1.jsp?idx=<%=idx%>">
  <tr>
   <td>
   ...
   <table class="table">
		...
		<tbody>
	     <tr>
	       <th>제목</th>
	     <td><input type="text" value = "<%=title%>" placeholder="제목을 입력하세요. " name="title" value = "<%=title%>" class="form-control"/></td>
	     </tr>
	     <tr>
	       <th>이름</th>
	     <td><input type="text" placeholder="제목을 입력하세요. " name="name" class="form-control"/></td>
			...
			<div class="form-write" onclick="javascript:replyCheck();">등록</div>
	        </td>
	        </tr>
		</tbody>
    </table>
