...
<%
   ...
   try {
      ...
      String sql = "SELECT USERNAME, TITLE, MEMO, TIME, HIT,LOVE FROM board1 WHERE NUM=" + idx;
...
<body>
    ...
    <tr height="35">
     ...
     <tr height="1" bgcolor="#dddddd"><td colspan="4" width="407"></td></tr>
                <tr>
      <td width="0"></td>
                   <td class="viewtxt" colspan="2" height="200"><br><br><%=memo %><br><br>
                   		<div class="form-loveit" onclick="javascript:location.href='loveit1.jsp?idx=<%=idx%>'">LOVE IT</div>
                   <br><br></td>
                </tr>
                <% 
...
%>
     ...
     <tr align="center">
      <td width="0">&nbsp;</td>
		<td colspan="2">
		<div class="form-write" onclick="javascript:location.href='reply1.jsp?idx=<%=idx%>'">답글</div>
		<div class="form-write" onclick="javascript:location.href='list1.jsp'">목록</div>
    	</td>
    <td width="0">&nbsp;</td>
     </tr>
    </table>
