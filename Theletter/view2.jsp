...
<%
   ...
   try {
      ...
      String sql = "SELECT USERNAME, TITLE, MEMO, TIME, HIT,LOVE FROM board2 WHERE NUM=" + idx;
     ...
     <tr height="1" bgcolor="#dddddd"><td colspan="4" width="407"></td></tr>
      ...
      <td width="0"></td>
                   <td class="viewtxt" colspan="2" height="200"><br><br><%=memo %><br><br>
                   		<div class="form-loveit" onclick="javascript:location.href='loveit2.jsp?idx=<%=idx%>'">LOVE IT</div>
                   <br><br></td>
                </tr>
                <% 
...
%>
     ...
     <tr align="center">
      <td width="0">&nbsp;</td>
		<td colspan="2">
		<div class="form-write" onclick="javascript:location.href='reply2.jsp?idx=<%=idx%>'">답글</div>
